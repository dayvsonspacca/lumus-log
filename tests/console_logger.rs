...
fn test_warn_with_datetime_info_message() {
    ...
    assert_eq!(
        warn,
        format!("[ {} - Warn ] - Warn message", datetime_now).yellow()
    );
}
...
fn test_warn_with_date_info_message() {
    ...
    assert_eq!(
        warn,
        format!("[ {} - Warn ] - Warn message", date_now).yellow()
    );
}
...
fn test_info_with_datetime_info_message() {
    ...
    assert_eq!(
        info,
        format!("({}) - (Info) - (Info message)", datetime_now).blue()
    );
}
...
fn test_info_with_date_info_message() {
    ...
    assert_eq!(
        info,
        format!("|{} | | Info | - |Info message|", date_now).blue()
    );
}
...
fn test_debug_message_datetime_info() {
    ...
    assert_eq!(
        debug,
        format!("Debug message - Debug message -> {} (Debug)", datetime_now).purple()
    );
}
...
fn test_error_with_datetime() {
    ...
    assert_eq!(
        error,
        format!("An error occurred at {}", datetime_now).red()
    );
}
